...
export default function AdminLayout({
  ...
  const navigation = [
    ...
    // },
    {
      name: '배송 관리',
      href: '/admin/delivery',
      current: pathname === '/admin/delivery',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      current: pathname === '/admin/customers' || pathname === '/admin/customers/hypetown',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      current: pathname === '/admin/create-order',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
